...
import="java.util.*,org.jessma.util.*,org.jessma.util.http.HttpHelper,org.jessma.mvc.Action" %>
...
<c:if test="${systemType eq 'windows' }">
	<c:set var="imagePath" value="${pageContext.request.contextPath}"/> 
</c:if>
<%
...
<script type="text/javascript">
	function orgList()
	{
		location.href="appManger!queryList.action";
	}
	function taskList()
	{
		location.href="task!queryTask.action";
	}
	function voite(){
		location.href="vote!vote.action";
	}
</script>